...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* --- MODAL DE PAGO --- */}
      {showPaymentForm && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm overflow-y-auto">
          <PaymentForm 
            planName="STUDIO PASS"
